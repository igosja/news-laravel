...
<ul class="list-inline text-center">
    <li class="list-inline-item">
        <a class="btn btn-default" href="(( path('admin_language_create') ))">Create</a>
    </li>
</ul>
        ...
        <table class="table table-bordered table-hover">
            ...
            <tr data-key="(( language.id ))">
                ...
                <td class="text-center">
                    <a href="(( path('admin_language_view', ('id': language.id)) ))" title="Переглянути"
                    ...
                    <a href="(( path('admin_language_update', ('id': language.id)) ))" title="Оновити"
                    ...
                    <a href="(( path('admin_language_delete', ('id': language.id)) ))" title="Видалити"
                       aria-label="Видалити" data-pjax="0" data-confirm="Ви впевнені, що хочете видалити цей елемент?"
                       data-method="post">
                        <svg aria-hidden="true"
